...
// Copyright (c) 2011-2012 EuroBit Developers
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #EuroBitTEST0\r");
            Send(hSocket, "WHO #EuroBitTEST0\r");
        } else {
            // randomly join #EuroBit00-#EuroBit99
            ...
            Send(hSocket, strprintf("WHO #EuroBit%02d\r", channel_number).c_str());
        }
